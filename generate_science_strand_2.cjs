...
const markdownPath = path.join(__dirname, 'docs', 'curriculum', 'science', 'band_2_templates_strand_2.md');
fs.writeFileSync(markdownPath, markdownContent);
console.log(`Generated Strand 2 Markdown at ${markdownPath}`);
...
const jsonPath = path.join(__dirname, 'curriculum_data', 'science_band_2_strand_2.json');
fs.writeFileSync(jsonPath, JSON.stringify(allTemplates, null, 2));
console.log(`Generated Strand 2 JSON at ${jsonPath}`);
