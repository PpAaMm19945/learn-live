 ...
 * 
 * Each entry describes a map file in R2 (learnlive-assets-prod/assets/maps/)
 * with its geographic coverage, relevant chapters, and a description the agent
 * can use to decide when to display it.
 * 
 * The agent receives this registry at session start so it can intelligently
 * select maps throughout the lesson without hardcoded naming conventions.
 */
...
export const MAP_REGISTRY: MapSpec[] = [
  {
    ...
    description: 'Shows the dispersion of Noah\'s three sons (Shem, Ham, Japheth) and their descendants across the ancient world. Highlights the Hamitic peoples — Mizraim (Egypt), Cush (Nubia/Ethiopia), Phut (Libya), and Canaan. Essential for Genesis 10 Table of Nations teaching.',
  ...
  },
  {
    ...
    description: 'The Nile Valley from the Delta to Upper Egypt and Nubia. Shows major cities, pyramids, and the geographic relationship between Lower Egypt (Delta) and Upper Egypt. Key for understanding Egyptian civilization as a Hamitic achievement.',
  ...
  },
  {
    ...
    description: 'The lands of Phut — showing Carthage, Numidia, and the Berber/Amazigh territories. Illustrates the Phoenician trading network and Hannibal\'s domain. Essential for teaching the African identity of Carthage.',
  ...
  },
  {
    ...
    description: 'The Cushite kingdoms along the Upper Nile — Kerma, Napata, and Meroë. Shows the relationship between Kush and Egypt, the iron-smelting centers, and the trade routes into sub-Saharan Africa.',
  ...
  },
  {
    ...
    description: 'Roman provinces of Africa Proconsularis, Numidia, Mauretania, and Cyrenaica. Shows the key cities of the early African church — Carthage, Hippo, Thagaste. Essential for teaching Augustine, Tertullian, and Cyprian as African theologians.',
  ...
  },
  {
    ...
    description: 'Egypt under Roman and Byzantine rule. Shows Alexandria as a center of Christian theology, the Catechetical School, the Desert Fathers in the Egyptian wilderness, and the Coptic heartland.',
  ...
  },
  {
    ...
    description: 'The Aksumite Empire at its height — showing Aksum, Adulis (the Red Sea port), trade routes to India and Arabia, and the Ethiopian highlands. Key for teaching the conversion of Ethiopia and the Ark of the Covenant tradition.',
  ...
  },
  {
    ...
    description: 'The great Bantu migration routes from the Niger-Congo homeland across central, eastern, and southern Africa. Shows the spread of iron-working, agriculture, and language families. Critical for understanding the peopling of Africa.',
  ...
  },
  {
    ...
    description: 'Medieval Ethiopia — isolated but enduring. Shows the rock-hewn churches of Lalibela, the Zagwe and Solomonic territories, Muslim sultanates on the coast, and Ethiopian connections to Jerusalem.',
  ...
  },
  {
    ...
    description: 'The Swahili coast trading cities — Kilwa, Mombasa, Zanzibar, Mogadishu — and their Indian Ocean trade network linking Africa to Arabia, Persia, India, and China. Shows monsoon wind patterns and gold/ivory trade routes.',
    keyLocations: ['Kilwa', 'Mombasa', 'Zanzibar', 'Great Zimbabwe', 'Mogadishu', 'Sofala', 'Malindi'],
    orientation: 'landscape',
  },
  {
    r2Key: 'assets/maps/map_001_post_babel_dispersion.png',
    ...
    primaryChapters: [],
    relevantChapters: ['ch01', 'ch02', 'ch03', 'ch04', 'ch05', 'ch06', 'ch07', 'ch08', 'ch09', 'ch10'],
    description: 'A full-continent overview map showing all major kingdoms, trade routes, and migration patterns discussed across the entire curriculum. Useful as an introductory or summary map for any chapter.',
    keyLocations: ['Egypt', 'Carthage', 'Aksum', 'Great Zimbabwe', 'Kilwa', 'Timbuktu', 'Meroë'],
    orientation: 'landscape',
  },
];
 ...
 * Falls back to Map 011 (overview) if no primary is found.
 */
export function getPrimaryMapForChapter(chapterId: string): MapSpec {
  ...
  // Fallback to overview map
  return MAP_REGISTRY[MAP_REGISTRY.length - 1];
}
 ...
 * This lets the agent know what maps are available and when to show them.
 */
...
When you want to INTERACT with the map (zoom, mark cities, draw routes), call set_scene("map") to switch to the interactive MapLibre view, then use zoom_to, place_marker, draw_route, etc. When you're done with interactive map work, the student returns to the auto-scrolling primary map.
...
3. Use set_scene("map") + zoom_to + place_marker for interactive exploration. Always zoom first, then mark.
