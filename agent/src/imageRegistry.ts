...
export const IMAGE_REGISTRY: ImageEntry[] = [
  ...
  // ──────────────────────────────────────────────
  { r2Key: 'assets/storybook/ch01/band0_page01.jpg', description: 'God creating the world — creation scene', chapters: ['ch01'], category: 'storybook', minBand: 0, maxBand: 1 },
  { r2Key: 'assets/storybook/ch01/band0_page02.jpg', description: 'The Fall of Man — Adam and Eve', chapters: ['ch01'], category: 'storybook', minBand: 0, maxBand: 1 },
  { r2Key: 'assets/storybook/ch01/band0_page03.jpg', description: 'The Tower of Babel — people building the tower', chapters: ['ch01'], category: 'storybook', minBand: 0, maxBand: 1 },
  { r2Key: 'assets/storybook/ch01/band0_page04.jpg', description: 'The promise of redemption — protoevangelium', chapters: ['ch01'], category: 'storybook', minBand: 0, maxBand: 1 },
  { r2Key: 'assets/storybook/ch01/band0_page05.jpg', description: 'Noah\'s Ark and the Flood', chapters: ['ch01'], category: 'storybook', minBand: 0, maxBand: 1 },
  { r2Key: 'assets/storybook/ch01/band0_page06.jpg', description: 'The sons of Noah — Shem, Ham, and Japheth', chapters: ['ch01'], category: 'storybook', minBand: 0, maxBand: 1 },
  { r2Key: 'assets/storybook/ch01/band0_page07.jpg', description: 'The scattering of nations from Babel', chapters: ['ch01'], category: 'storybook', minBand: 0, maxBand: 1 },
  { r2Key: 'assets/storybook/ch01/band0_page08.jpg', description: 'The sons of Ham — founders of African civilizations', chapters: ['ch01'], category: 'storybook', minBand: 0, maxBand: 1 },

  // Storybook — Chapter 1, Band 1
  { r2Key: 'assets/storybook/ch01/band1_page01.jpg', description: 'Creation — illustrated for Band 1', chapters: ['ch01'], category: 'storybook', minBand: 0, maxBand: 2 },
  { r2Key: 'assets/storybook/ch01/band1_page02.jpg', description: 'The Garden of Eden — Band 1', chapters: ['ch01'], category: 'storybook', minBand: 0, maxBand: 2 },
  { r2Key: 'assets/storybook/ch01/band1_page03.jpg', description: 'The Fall — Band 1', chapters: ['ch01'], category: 'storybook', minBand: 0, maxBand: 2 },
  { r2Key: 'assets/storybook/ch01/band1_page04.jpg', description: 'Cain and Abel — Band 1', chapters: ['ch01'], category: 'storybook', minBand: 0, maxBand: 2 },
  { r2Key: 'assets/storybook/ch01/band1_page05.jpg', description: 'Noah and the Flood — Band 1', chapters: ['ch01'], category: 'storybook', minBand: 0, maxBand: 2 },
  { r2Key: 'assets/storybook/ch01/band1_page06.jpg', description: 'The covenant rainbow — Band 1', chapters: ['ch01'], category: 'storybook', minBand: 0, maxBand: 2 },
  { r2Key: 'assets/storybook/ch01/band1_page07.jpg', description: 'Table of Nations — Band 1', chapters: ['ch01'], category: 'storybook', minBand: 0, maxBand: 2 },
  { r2Key: 'assets/storybook/ch01/band1_page08.jpg', description: 'Tower of Babel — Band 1', chapters: ['ch01'], category: 'storybook', minBand: 0, maxBand: 2 },
  { r2Key: 'assets/storybook/ch01/band1_page09.jpg', description: 'The scattering — Band 1', chapters: ['ch01'], category: 'storybook', minBand: 0, maxBand: 2 },
  { r2Key: 'assets/storybook/ch01/band1_page10.jpg', description: 'Mizraim settles Egypt — Band 1', chapters: ['ch01'], category: 'storybook', minBand: 0, maxBand: 2 },
  { r2Key: 'assets/storybook/ch01/band1_page11.jpg', description: 'Cush settles Nubia — Band 1', chapters: ['ch01'], category: 'storybook', minBand: 0, maxBand: 2 },
  { r2Key: 'assets/storybook/ch01/band1_page12.jpg', description: 'Phut settles Libya — Band 1', chapters: ['ch01'], category: 'storybook', minBand: 0, maxBand: 2 },
  { r2Key: 'assets/storybook/ch01/band1_page13.jpg', description: 'Canaan settles the coast — Band 1', chapters: ['ch01'], category: 'storybook', minBand: 0, maxBand: 2 },
  { r2Key: 'assets/storybook/ch01/band1_page14.jpg', description: 'God\'s plan for the nations — Band 1', chapters: ['ch01'], category: 'storybook', minBand: 0, maxBand: 2 },
  { r2Key: 'assets/storybook/ch01/band1_page15.jpg', description: 'Looking ahead to Africa\'s story — Band 1', chapters: ['ch01'], category: 'storybook', minBand: 0, maxBand: 2 },
];
