      ...
      <div className="w-full max-w-2xl">
        ...
        <Card className="relative overflow-hidden border border-border/50 bg-card/60 backdrop-blur-xl shadow-xl min-h-[400px] flex flex-col">
          <AnimatePresence mode="wait" custom={1}>
            ...
            >
              {step === 1 && (
                <div className="flex-grow p-8 space-y-6 flex flex-col justify-center">
                  ...
                  <CardHeader className="px-0 pt-0 text-center">
                    ...
                    <CardDescription className="text-lg">Let's set up your family.</CardDescription>
                  </CardHeader>
                  <CardContent className="px-0">
                     <div className="space-y-2 max-w-sm mx-auto">
                       <Label htmlFor="familyName">Parent Name</Label>
                       <Input
                         id="familyName"
              ...
              {step === 3 && (
                <div className="flex-grow flex flex-col justify-center items-center text-center p-8 space-y-6">
                   ...
                   <CardDescription className="text-lg max-w-md">
                     Your family profile for <strong>{familyName}</strong> is ready.
          ...
          <CardFooter className="border-t bg-muted/20 p-4 flex justify-between shrink-0">
             ...
             {step < totalSteps ? (
               ...
               <Button onClick={handleFinish} disabled={isSubmitting}>
                  ...
                  Start Learning <IconArrowRight className="ml-2 h-4 w-4" />
               </Button>
             )}
          </CardFooter>
        </Card>
